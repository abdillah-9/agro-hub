...
export default function OnSalesTable({shownData, crops}) {
    ...
    const {buy_crop_form, setBuy_crop_form, setMore_details} = useContext(HandleBuyCropsFormContext);
...
return (
    <div style={{width:"100%",overflow:"auto"}}>
        <table style={tableContainer}>
           ...
           <tbody>
                { 
                    crops && crops?.onsale_crops ?
                    crops?.onsale_crops.map((entry, val)=>
                    <tr key={val}>
